...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4219602725U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2527768216U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4062856108U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1785716290U);
}
...
{
  return "syvY0ZsCa5NmDQctuHX8ScH";
}
...
const char* sf_c2_tomas_get_post_codegen_info(void)
{
  return
    (
     "eNrtVctq20AUlY0bEmiDCYVussiu3TUUCtkljR/E4DxaJe5jEybStTV4NKPOQ4l3WXZV6B/0V7r"
     "rR/Qjsu+ivZIVW8iSnMQkUKhgPBr53HOfc69V6exb+Kzi+ok/S7gv46pa4+dRcq6k1vh7zXqenE"
     "8QxI1/RCTxlVX6cOLDO1CCGU0F7/C+yIVR3gcJ3EFsIKQuYlPUN4zyYdtwJ+JT7z3qeLYnDHN3U"
     "Za4h5yNkC0w+gh5mlSCo9sArvakMAOvzchgYrHU5w0PnKEyfpkLCrRtgsgstW+YpgGD1gU4Ha40"
     "QYvV1DZbEw0NfVHoZuSpsq+Bwg8YJTzXW48oGwIMsIaTwMXfQ6PRqSzM8YjUu+CREFSXDmNOwSH"
     "LSRX+cUY50UJSwlo+a0SCs7YdMbRnX7jASgKCtu1KIMNAUK6L82+30dMWJ2cMmnBmBsVsNnw2Uf"
     "J7FM5BFsat3xAhSDKAQ16oNA5I6yLO1qRKZmGa+tAj8o2D+VPgFlYvVo6yCeYJjlGiCAaxkx11L"
     "GmI4S1kM34nqsx5V8b442SrebCYrRVCWRYmbG2HNwhjqhB2LIIuhMBi1ibRpBw2Zs3HBVIEZIBV"
     "62KQoxJvCO7SmVw4RmnhN7Dcmt3uAXaKfOOmsA7XIPvEgbx7qxwPXMMAHcXOpGN1OaQuVVG25qC"
     "SnM5DWapvePNcyCE6WnLtpy5EOSjrD1Ff3rSmffnxDfrytVx2f5HiqeTwWKk9q3elWq63im+VRG"
     "4nJfcko6eWkYtwdVwve/7X33/Wf1xe/tpe7n35toj+79XbzbHV5Lx+3TAm5RTOZDHC7qXsquXwP"
     "0vx15OzGoUfNz+pBnl94DffOtrsfdiynb2Y76pSbm81Y+/1942oc42CuA8p6XTcZMBGZ2LGYyfi"
     "30rZuzQnHivJ9/Fztb2Y/NOdbB5rc+Tr+DbK1O3d9W/sLCZ/s3yvZfK9Fs+nU4LTJoRT59Up3nW"
     "iZu/jXev7tnLWA8v9K3b+j8v9+3eTefXQctYDyy3q323n9iJzPtvfrAy+voCe+8an97/9W0wh"
     );
}
...
static void mdlSetWorkWidths_c2_tomas(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2389530159U));
  ssSetChecksum1(S,(3239903227U));
  ssSetChecksum2(S,(1071415424U));
  ssSetChecksum3(S,(2441631240U));
}
