...
static void c5_chartstep_c5_tomas(SFc5_tomasInstanceStruct *chartInstance)
{
  ...
  for (c5_i18 = 0; c5_i18 < 19200; c5_i18++) {
    c5_BW[c5_i18] = ((real_T)c5_outputImage[c5_i18] > 76.5);
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3534329946U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2613734903U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1765446277U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(378739616U);
}
...
{
  return "sGGKjqadjBeAyPXdJpKVr6E";
}
...
const char* sf_c5_tomas_get_post_codegen_info(void)
{
  return
    (
     "eNrtVc1u00AQttOAqARVVKFy6aGc4AgHEDfa/JXQlEakTblVW3sSb7Pedfcnbd6GIzdegyfgOXr"
     "hwomx82cc22kbtRISK23Wu/nmm5md2RnLbuxbONZw/sCfh7g+wlmwRuPBeG/H5ui8aL0Y748QxI"
     "3fIpL4ysodnPjwGZRgRlPBG7wrUmGUd0ECdxAbCKmz2BT1DaO8XzfcCfnUsUcdr+0Jw9wyyhL3g"
     "LMhsgVGt5CnSiU4ug7gak8K0/PqjPSmFkt9UfHA6Svj57mgQLdNEJql9g3TNGBQuwSnwZUmaLGa"
     "2dbWRENFX2a6GXqq2hOg8ANGCU/11iOqDQFesIajwMXfA6PRqSTM8YjUZfDIAFST9iNOwSHJSRX"
     "+cUo50UJSwmo+q4SC87a1GNqzL1xgOReCtpUlkH4gKNfZ8W/X0dMaJ6cMqnBqetlsbTg3YfA7FC"
     "5AZt5btyIGIEkPDnim0uhCapdRtKZZMg/T1IcOkTsOxk+Bm5m9mDmqTTBOcIgSWTCInGyoQ0kHe"
     "L2ZbMZvhJm56MkYfxRstQgWsdUGkBeFKVvd4RXCmMqEHYqgCQNgEWuVaJIPG7Gm4wIpAtLDrHXx"
     "ksMUrwju0rlYOEZp4Vcw3arN5iesFOnGzWANrkF2iQNp71Y5HriGATqKlUlH6lJIXarCaC1AjWO"
     "6CGWpruHVCyH76GjOs5+5EMYgrz6EdfmVNavLj69RlydyyfVljMdO4bFia1LvauFv/EpCbwFPbN"
     "uO5LZjck8SeooJuRBXwtn5vTH89fzn8beN13SzNPy+SL89p9+OvkO5r4Wb9bG18X5zUjCm6TSYi"
     "2KI/RCzq5jC/yzGXxrv1e7u3tk5cc/KsDNsfXE/Bnsd+bYW8V3Z+fYWEvZOzrfCyjUMojqkpNNw"
     "xw023BMzajsh/7uYvQ8X3Mfq+Hw0rt4vJ/90OxnH4gL5En4NE3l7e/1b28vJXy/e64l4r0f96YR"
     "gtxnAifPmBN86UfPv8bb5fVM5657l/hU7/9/L3ft3nX61cks5e8n+eF9yy/p30769TJ9P1jcrgS"
     "8toeeu8fH1D14bSxs="
     );
}
...
static void mdlSetWorkWidths_c5_tomas(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2031549014U));
  ssSetChecksum1(S,(1473651189U));
  ssSetChecksum2(S,(1764824744U));
  ssSetChecksum3(S,(2943946780U));
}
