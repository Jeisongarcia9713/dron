  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2814472962U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2661477017U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2701538636U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(5995469U);
    } else {
      return 0;
    }
  } else {
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3002773898U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2514967129U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(148637777U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(991140874U);
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 5:
      {
        if (strcmp(instanceChksum, "sSG89PvKCbO9t7UzRjIvn2F") == 0) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 5:
      {
        if (strcmp(tpChksum, "sSG89PvKCbO9t7UzRjIvn2F") == 0) {
  ...
  debugInstance)
{
  _flightControlSystemMachineNumber_ = sf_debug_initialize_machine(debugInstance,
    "flightControlSystem","sfun",0,5,0,0,0);
