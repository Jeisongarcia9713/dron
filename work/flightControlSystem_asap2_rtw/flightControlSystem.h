...
#define MODEL_NAME                     flightControlSystem
#define NSAMPLE_TIMES                  (2)                       /* Number of sample times */
#define NINPUTS                        (38402)                   /* Number of model inputs */
#define NOUTPUTS                       (5)                       /* Number of model outputs */
#define NBLOCKIO                       (33)                      /* Number of data output port signals */
...
typedef struct {
  ...
  real_T Add[2];                       /* '<S70>/Add' */
  real_T Add_ief3tvrper[2];            /* '<S65>/Add' */
  real32_T Product_m2bcxc3hq4[3];      /* '<S34>/Product' */
  real32_T sincos_o2_kq55ojr1f2[3];    /* '<S105>/sincos' */
  real32_T FIR_IMUaccel[3];            /* '<S37>/FIR_IMUaccel' */
  real32_T Sum_mah4rh5nu3[3];          /* '<S34>/Sum' */
  real_T Add_ol0omud3hx;               /* '<S4>/Add' */
  real_T Product2[2];                  /* '<S91>/Product2' */
  real_T Product3[2];                  /* '<S90>/Product3' */
  real_T yaw;                          /* '<S5>/Chart' */
  real_T u_ch4zj0naok;                 /* '<S4>/   ' */
  real_T rtb_Product1_tmp;
  real_T rtb_Product1_tmp_kkiq3xxxve;
  real32_T Akxhatkk1_f5py5lpkz4[2];    /* '<S140>/A[k]*xhat[k|k-1]' */
  uint32_T FixPtSwitch;                /* '<S16>/FixPt Switch' */
  uint32_T FixPtSwitch_efg3mboxv2;     /* '<S32>/FixPt Switch' */
  uint32_T FixPtSwitch_kiztrseemx;     /* '<S110>/FixPt Switch' */
  real32_T inverseIMU_gain[6];         /* '<S37>/inverseIMU_gain' */
  real32_T Merge[2];                   /* '<S34>/Merge' */
  real32_T TSamp[2];                   /* '<S111>/TSamp' */
  real32_T Add_l4du2kzkfo[2];          /* '<S145>/Add' */
  real32_T TmpSignalConversionAtsincosInport1[3];
  real32_T DiscreteTimeIntegrator[2];  /* '<S7>/Discrete-Time Integrator' */
  real32_T MotorDirections[4];         /* '<S12>/MotorDirections' */
  real32_T Product[3];                 /* '<S98>/Product' */
  real32_T Add_m44y1dersg[2];          /* '<S140>/Add' */
  real32_T Add_o0zm3by3ri[2];          /* '<S7>/Add' */
  real32_T I_pr;                       /* '<S11>/I_pr' */
  ...
  real32_T z;                          /* '<S5>/Chart' */
  real32_T numAccum;
  real32_T numAccum_cxarnvbvui;
  uint8_T Merge_mkzjcaq3mk;            /* '<S4>/Merge' */
  boolean_T Compare_nuuzxwlhye;        /* '<S13>/Compare' */
...
typedef struct {
  ...
  real_T soonarFilter_IIR_tmp;         /* '<S45>/soonarFilter_IIR' */
  real_T vel;                          /* '<S5>/Chart' */
  ...
  real32_T pressureFilter_IIR_tmp;     /* '<S45>/pressureFilter_IIR' */
  real32_T IIR_IMUgyro_r_tmp;          /* '<S37>/IIR_IMUgyro_r' */
  ...
  boolean_T EnabledSubsystem_MODE_n2f2djip0m;/* '<S70>/Enabled Subsystem' */
  boolean_T MeasurementUpdate_MODE_nji240zmrw;/* '<S65>/MeasurementUpdate' */
...
typedef struct {
  ...
  real_T alerta;                     /* '<S2>/Deteccion de lineas verticales' */
...
/* Constant parameters (default storage) */
extern const ConstP_flightControlSystem_T flightControlSystem_rtConstP;
